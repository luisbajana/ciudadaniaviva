...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { cause_id: @testimonial.cause_id, testimonial: @testimonial.testimonial, title: @testimonial.title, user_id: @testimonial.user_id }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { cause_id: @testimonial.cause_id, testimonial: @testimonial.testimonial, title: @testimonial.title, user_id: @testimonial.user_id }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
