...
class DirectoriesControllerTest < ActionController::TestCase
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post :create, directory: { category: @directory.category, location_id: @directory.location_id, name: @directory.name, url: @directory.url }
    end
  ...
  test "should update directory" do
    put :update, id: @directory, directory: { category: @directory.category, location_id: @directory.location_id, name: @directory.name, url: @directory.url }
    assert_redirected_to directory_path(assigns(:directory))
  end
